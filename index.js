...
function Menu() {
  ...
  this.el.hover(bind(this, this.deselect));
  $('html').click(bind(this, this.hide));
...
Menu.prototype.bindKeyboardEvents = function(){
  $(document).bind('keydown.menu', bind(this, this.onkeydown));
  return this;
};
...
Menu.prototype.add = function(text, alias, fn){
  var slug;
